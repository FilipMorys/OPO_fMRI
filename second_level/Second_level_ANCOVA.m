function [] = Second_level_ANCOVA(ncond,covs,ncov,cov_names,model_dir,files,model_name)
...
for f=1:ncond
    matlabbatch{1}.spm.stats.factorial_design.des.anova.icell(f).scans = files(:,f);
end
